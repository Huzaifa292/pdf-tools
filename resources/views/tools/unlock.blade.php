<x-app-layout>
<x-slot name="title">Unlock PDF - PDFTools</x-slot>
<div class="max-w-2xl mx-auto text-center py-10">
    <div class="w-20 h-20 rounded-3xl bg-gradient-to-br from-pink-500 to-rose-500 flex items-center justify-center text-4xl mx-auto mb-6 shadow-xl">🔓</div>
    <h1 class="text-4xl font-extrabold text-white">Unlock PDF</h1>
    <p class="text-slate-400 mt-3 text-lg">Remove password protection from your PDF.</p>
    ...
    <form method="POST" action="/unlock-pdf" enctype="multipart/form-data" class="mt-8">
        @csrf
        ...
        <button type="submit" class="mt-6 w-full py-4 bg-red-500 hover:bg-red-600 rounded-2xl font-bold text-white text-lg transition">Unlock PDF ↓</button>
    </form>
