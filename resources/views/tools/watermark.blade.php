<x-app-layout>
<x-slot name="title">Watermark PDF - PDFTools</x-slot>
<div class="max-w-2xl mx-auto text-center py-10">
    <div class="w-20 h-20 rounded-3xl bg-gradient-to-br from-teal-500 to-cyan-500 flex items-center justify-center text-4xl mx-auto mb-6 shadow-xl">💧</div>
    <h1 class="text-4xl font-extrabold text-white">Watermark PDF</h1>
    <p class="text-slate-400 mt-3 text-lg">Add a text watermark stamp to your PDF.</p>
    ...
    <form method="POST" action="/watermark-pdf" enctype="multipart/form-data" class="mt-8">
        @csrf
        ...
        <div class="mt-4 text-left">
            <label class="text-slate-300 text-sm font-medium">Watermark Text</label>
            <input type="text" name="text" placeholder="e.g. CONFIDENTIAL" maxlength="30" required
        ...
        <button type="submit" class="mt-6 w-full py-4 bg-red-500 hover:bg-red-600 rounded-2xl font-bold text-white text-lg transition">Add Watermark ↓</button>
    </form>
